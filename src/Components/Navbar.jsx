      ...
      >
       ...
       <h4>Sign in / Sign up</h4>
        ...
        <div id={Style.newnav}>
          ...
          <div  onMouseLeave={() => setNav(false)}  onMouseEnter={() => setNav(true)}  className={Style.navbar2style1}>
            <p>Groceries</p>
         ...
         {nav && (
            <div style={{display:"block"}} >  I'll appear when you hover over the button.
               </div>
         )}
